...
OUTPUT = BASE_DIR / "Imairuka_user_manual_20260517.docx"
FONT = "Yu Gothic"
...
def build():
    ...
    add_section(
        doc,
        "1. ログイン",
        "発行されたメールアドレスとパスワードでログインします。ログイン後は、契約中の会社データだけを操作します。",
        [
    ...
    add_bullets(
        ...
        [
            ...
            "本マニュアルの画面は2026年5月17日時点のものです。実際の契約状態や権限により一部表示が異なる場合があります。",
        ],
    )
